  ...
  (test-suite 
   ...
   (test-case
    ...
    (parameterize*
     ...
     (check-equal? (get-code-generator-poly) "x4+15x3+3x2+x+12"))
    ...
    (parameterize*
     ...
     (check-equal? (get-code-generator-poly) "x16+59x15+13x14+104x13+189x12+68x11+209x10+30x9+8x8+163x7+65x6+41x5+229x4+98x3+50x2+36x+59"))
    )
